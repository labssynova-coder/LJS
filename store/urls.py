...
from store.forms import LoginForm, CustomPasswordChangeForm, CustomPasswordResetForm, CustomSetPasswordForm
from . import views
...
urlpatterns = [
    ...
    path('accounts/remove-address/<int:address_id>/', views.remove_address, name="remove-address"),
    ...
    path('accounts/password-change/', auth_views.PasswordChangeView.as_view(
        ...
        success_url=reverse_lazy('store:password-change-done'),
